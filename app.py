...
st.set_page_config(
    ...
    menu_items={
        'Get Help': None,  # Hides the "Get Help" menu item
        'Report a bug': None,  # Hides the "Report a bug" menu item  
        'About': f"""
        ...
        *For support, please contact The ATM Agency directly.*
        """
    }
)
...
<style>
    ...
    /* =====================================================
       COMPREHENSIVE STREAMLIT BRANDING & UI HIDING
       For Public Streamlit Community Cloud Deployment
       This hides GitHub links, fork buttons, Streamlit branding,
       deployment badges, and all default UI chrome
       ===================================================== */
    
    /* ----- MAIN MENU & HEADER HIDING ----- */
    /* Hide the hamburger menu (three dots) in top right */
    #MainMenu {{
    ...
    /* Hide the entire header bar if needed (uncomment if you want full header hidden) */
    ...
    /* ----- ADDITIONAL SAFETY CATCHES ----- */
    /* Catch-all for any remaining Streamlit UI elements */
    [data-testid*="Badge"] {{
        display: none !important;
    }}
    ...
    /* Hide any absolute positioned badges */
    ...
    /* =====================================================
       END COMPREHENSIVE HIDING SECTION
       ===================================================== */
    ...
    [data-testid="stSidebarNavToggle"]:hover {{
