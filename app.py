...
st.set_page_config(
    ...
    menu_items={
        'Get Help': None,  # Completely hidden
        'Report a bug': None,  # Completely hidden
        'About': None  # Completely hidden - removes all menu items
    }
)
...
<style>
    ...
    /* =====================================================
       ULTIMATE STREAMLIT BRANDING, GITHUB & UI HIDING
       For Public Streamlit Community Cloud Deployment
       
       This is the most comprehensive hiding system that covers:
       - GitHub links, fork buttons, star buttons, repo badges
       - Streamlit branding, logos, "Made with Streamlit"
       - Deployment badges, viewer badges, profile containers
       - Settings menus, share buttons, action menus
       - Developer mode indicators, status widgets
       - All header/toolbar UI chrome
       - Sidebar completely hidden
       - All Community Cloud specific elements
       
       Updated: 2026 - Covers all known Streamlit versions
       ===================================================== */
    
    /* ===========================================
       SECTION 1: COMPLETE SIDEBAR REMOVAL
       =========================================== */
    ...
    /* Hide sidebar navigation toggle */
    ...
    /* Alternative sidebar selectors for different versions */
    ...
    /* Remove sidebar gap/margin from main content */
    ...
    /* ===========================================
       SECTION 2: MAIN MENU & HEADER HIDING
       =========================================== */
    
    /* Hide the hamburger menu (three dots) in top right - ALL versions */
    #MainMenu {{
        visibility: hidden !important;
        display: none !important;
        opacity: 0 !important;
    ...
    /* Alternative MainMenu selectors */
    ...
    /* Hide the entire header bar completely */
    ...
    /* ----- TOOLBAR & CONTROLS HIDING ----- */
    /* Hide the top-right toolbar (share, star, etc.) */
    ...
    /* Alternative toolbar selectors for different Streamlit versions */
    .stToolbar {{
        display: none !important;
        visibility: hidden !important;
    }}
    ...
    /* Hide toolbar action buttons specifically */
    [data-testid="stToolbarActions"] {{
        display: none !important;
        visibility: hidden !important;
    }}
    
    /* ----- DECORATION & STATUS HIDING ----- */
    /* Hide the colored line decoration at the top */
    ...
    /* Hide status widget (running/stopped indicator) */
    ...
    /* Alternative status widget selectors */
    .stStatusWidget {{
        display: none !important;
    }}
    
    /* ----- GITHUB & VIEWER BADGE HIDING ----- */
    /* Primary GitHub/viewer badge containers - multiple class variations */
    ...
    /* Additional viewer badge class variations (Streamlit updates these) */
    .viewerBadge_link__qRIco {{
        display: none !important;
    }}
    
    .viewerBadge_text__1NxQo {{
        display: none !important;
    }}
    ...
    /* Hide any element containing "GitHub" in viewer badges */
    [class*="viewer"] a[href*="github"] {{
        display: none !important;
    }}
    
    /* ----- PROFILE CONTAINERS HIDING ----- */
    /* Profile preview and container classes */
    ...
    /* Wildcard profile class matching for different versions */
    ...
    /* ----- MANAGE APP BUTTON HIDING ----- */
    /* Hide "Manage app" button on Community Cloud */
    ...
    /* Alternative manage app selectors */
    button[kind="manage"] {{
        display: none !important;
    }}
    ...
    /* ----- GITHUB FORK BUTTON HIDING ----- */
    /* Hide GitHub fork/star buttons that appear on public apps */
    ...
    /* Hide any GitHub-related links in the header area */
    header a[href*="github.com"] {{
        display: none !important;
        visibility: hidden !important;
    }}
    
    /* ----- STREAMLIT LOGO & BRANDING HIDING ----- */
    ...
    /* Hide Streamlit footer specifically */
    ...
    /* Hide "Made with Streamlit" text anywhere */
    [class*="made-with-streamlit"],
    [class*="madeWithStreamlit"] {{
        display: none !important;
    }}
    
    /* ----- APP VIEW CONTAINER ADJUSTMENTS ----- */
    /* Hide the app view container badge area */
    .appview-container .main .block-container {{
        padding-top: 1rem;
    }}
    
    /* Hide any floating badges in app view */
    .appview-container [class*="Badge"] {{
        display: none !important;
    }}
    
    /* ----- SHARE BUTTON & MENU HIDING ----- */
    /* Hide share buttons */
    ...
    /* ----- COMMUNITY CLOUD SPECIFIC HIDING ----- */
    /* Hide Community Cloud specific elements */
    ...
    /* Hide viewer count or analytics badges */
    [class*="viewerCount"],
    [class*="analyticsWrapper"] {{
        display: none !important;
    }}
    
    /* ----- RUNNING/RERUN INDICATOR HIDING ----- */
    /* Hide the running spinner in top right */
    [data-testid="stSpinner"] {{
        /* Keep spinner visible but optional - uncomment to hide */
        /* display: none !important; */
    }}
    
    /* Hide "Running..." text if needed */
    .stRunning {{
        /* display: none !important; */
    }}
    
    /* ----- DEVELOPER MODE INDICATORS ----- */
    /* Hide developer mode warning banner */
    [data-testid="stAlert"] {{
        /* Only hide if it's the dev mode alert */
    }}
    
    /* Hide "App is running in developer mode" message */
    .stAlert[data-baseweb="notification"] {{
        /* Conditional hiding based on content */
    }}
    
    /* ----- IFRAME EMBED BADGES ----- */
    /* Hide badges that appear when app is embedded */
    .embed-badge,
    [class*="embedBadge"] {{
        display: none !important;
    }}
    
    /* ----- TOP RIGHT AREA COMPREHENSIVE CLEAN ----- */
    /* Nuclear option: hide everything in the top right toolbar area */
    .stApp header {{
        /* Adjust if you need header but not its contents */
    }}
    
    /* Clean the header actions area */
    header [data-testid="stToolbarActions"] > * {{
        display: none !important;
    }}
    
    /* But keep the header itself for potential app title */
    header[data-testid="stHeader"] {{
        background-color: transparent !important;
        border-bottom: none !important;
    }}
    
    /* ----- LINK ICON HIDING (Optional) ----- */
    /* Hide link icons that appear next to headers */
    ...
    /* ===========================================
       SECTION 3: GITHUB SPECIFIC HIDING
       NUCLEAR LEVEL - HIDES ALL GITHUB TRACES
       =========================================== */
    
    /* Hide ALL GitHub-related elements comprehensively */
    
    /* GitHub buttons - all variations */
    [data-testid="stGitHubButton"],
    [data-testid="stGithubButton"],
    [data-testid="StGitHubButton"],
    [data-testid="baseButton-github"],
    [data-testid*="github"],
    [data-testid*="GitHub"],
    [data-testid*="Github"],
    .stGitHubButton,
    ...
    /* GitHub links anywhere in the app - comprehensive */
    a[href*="github.com"],
    a[href*="github.io"],
    ...
    /* Hide any text containing "GitHub" in UI elements */
    [class*="github-text"],
    [class*="GitHubText"] {{
        display: none !important;
    }}
    ...
    /* ===========================================
       SECTION 4: STREAMLIT BRANDING HIDING
       =========================================== */
    
    /* Made with Streamlit - all variations */
    footer,
    .reportview-container .main footer,
    [data-testid="stFooter"],
    footer.streamlit-footer,
    ...
    /* ===========================================
       SECTION 5: VIEWER & PROFILE BADGES
       =========================================== */
    
    /* All viewer badge variations */
    .viewerBadge_container__r5tak,
    .styles_viewerBadge__CvC9N,
    .viewerBadge_link__qRIco,
    .viewerBadge_text__1NxQo,
    ...
    /* Profile containers - all variations */
    ._profileContainer_gzau3_53,
    ._profilePreview_gzau3_63,
    [class*="_profileContainer"],
    [class*="_profilePreview"],
    ...
    /* ===========================================
       SECTION 6: TOOLBAR & ACTION BUTTONS
       =========================================== */
    ...
    /* ===========================================
       SECTION 8: EMBED & IFRAME ELEMENTS
       =========================================== */
    
    /* Embed badges for iframes */
    .embed-badge,
    [class*="embedBadge"],
    [class*="EmbedBadge"],
    [class*="embed-badge"],
    ...
    /* ===========================================
       SECTION 9: CLOUD & COMMUNITY ELEMENTS
       =========================================== */
    ...
    /* Community Cloud elements */
    [class*="community"],
    [class*="Community"] {{
        /* Be careful not to hide user content */
    }}
    
    /* ===========================================
       SECTION 10: CATCH-ALL SAFETY RULES
       =========================================== */
    
    /* Any remaining badge elements */
    [data-testid*="Badge"],
    [data-testid*="badge"],
    [class*="Badge"]:not(.status-badge):not(.langchain-badge):not(.version-badge),
    .stApp > div:first-child > div > div > [class*="badge"],
    .stApp > div:first-child > div > div > [class*="Badge"] {{
        display: none !important;
        visibility: hidden !important;
    }}
    
    /* Hide any button with settings/config icons in header */
    header button[data-testid*="settings"],
    header button[data-testid*="config"],
    ...
    /* Hide developer mode alerts if they contain certain text */
    [data-testid="stAlert"]:has([data-testid*="developer"]),
    .stAlert:has([class*="developer"]) {{
        display: none !important;
    }}
    
    /* Ensure no Streamlit UI leaks through */
    .stApp::before,
    .stApp::after {{
    ...
    /* ===========================================
       SECTION 11: LINK HIDING IN HEADERS
       =========================================== */
    
    /* Hide anchor/link icons next to headers (optional - uncomment if needed) */
    /*
    h1 a, h2 a, h3 a, h4 a, h5 a, h6 a,
    .stMarkdown a.header-link,
    [class*="headerLink"],
    ...
    */
    ...
    /* =====================================================
       END ULTIMATE HIDING SECTION
       ===================================================== */
    
    /* =====================================================
       HORIZONTAL LAYOUT ENHANCEMENTS
       All content flows horizontally without sidebar
       ===================================================== */
    ...
    /* Remove any margin from sidebar absence */
    .stApp {{
        margin-left: 0 !important;
    }}
    ...
    /* Make columns more horizontal on wide screens */
    ...
    /* Horizontal expander content */
    .streamlit-expanderContent {{
        padding: 1rem 1.5rem;
    }}
    
    /* =====================================================
       END HORIZONTAL LAYOUT SECTION
       ===================================================== */
...
# =====================================================
# ENHANCED HORIZONTAL NAVIGATION (NO SIDEBAR)
# All features moved to main page with horizontal menus
# =====================================================
...
<style>
    ...
    .quick-actions-bar {{
        ...
        flex-wrap: wrap;
        align-items: center;
        border-top: 1px solid {PRIMARY_COLOR}15;
        margin-top: 1rem;
        padding-top: 1rem;
    }}
    ...
    /* Specialist Selector Horizontal */
    .specialist-selector {{
        display: flex;
        gap: 0.5rem;
        flex-wrap: wrap;
    ...
    .specialist-chip.active {{
        background: {PRIMARY_COLOR};
        color: white;
        border-color: {PRIMARY_COLOR};
    }}
    
    .specialist-chip:hover:not(.active) {{
        background: {BG_SECONDARY};
...
# Create the navigation bar with brand and status
nav_col1, nav_col2, nav_col3 = st.columns([2, 5, 3])
...
with nav_col3:
    ...
    api_connected = check_api_key()
    vector_active = st.session_state.doc_processor.vector_store is not None
    
    status_html = '<div class="status-pills">'
    
    # API Status
    if api_connected:
        status_html += '<span class="status-pill success">✓ API Connected</span>'
    else:
        status_html += '<span class="status-pill warning">⚠ API Required</span>'
    
    # Document Status
    if num_files > 0:
        status_html += f'<span class="status-pill info">📄 {num_files} Files</span>'
        if vector_active:
            status_html += '<span class="status-pill success">🔍 Vector Search Active</span>'
    
    status_html += '</div>'
    st.markdown(status_html, unsafe_allow_html=True)

# Handle page change
if selected_page != st.session_state.get("_prev_page"):
    st.session_state._prev_page = selected_page
    if selected_page != st.session_state.current_page:
        st.session_state.current_page = selected_page
        st.rerun()

# --- HORIZONTAL QUICK ACTIONS BAR (shown on relevant pages) ---
if st.session_state.current_page in ["Specialist Consultation", "Document Intelligence"]:
    st.markdown("---")
    
    # Specialist selection as horizontal buttons
    action_col1, action_col2 = st.columns([3, 1])
    
    with action_col1:
        st.markdown("**Select AI Specialist:**")
        specialist_names = list(SPECIALISTS.keys())
        specialist_cols = st.columns(len(specialist_names))
        
        for idx, spec_name in enumerate(specialist_names):
            spec = SPECIALISTS[spec_name]
            with specialist_cols[idx]:
                is_active = st.session_state.get("active_specialist") == spec_name
                btn_type = "primary" if is_active else "secondary"
                if st.button(
                    f"{spec['icon']} {spec_name.split()[0]}", 
                    key=f"spec_btn_{idx}",
                    type=btn_type,
                    use_container_width=True
                ):
                    st.session_state.active_specialist = spec_name
                    st.rerun()
        
        # Show selected specialist info
        if st.session_state.get("active_specialist"):
            spec = SPECIALISTS[st.session_state.active_specialist]
            st.markdown(f"""
            <div style='background: linear-gradient(135deg, {spec['color']}15, {spec['color']}05); 
                        padding: 0.75rem 1rem; border-radius: 12px; margin-top: 0.5rem;
                        border-left: 4px solid {spec['color']}; display: flex; align-items: center; gap: 1rem;'>
                <span style='font-size: 1.5rem;'>{spec['icon']}</span>
                <div>
                    <strong style='color: {spec['color']};'>{st.session_state.active_specialist}</strong>
                    <span style='color: #64748B; font-size: 0.85rem; margin-left: 0.5rem;'>{spec['bio'][:80]}...</span>
                </div>
            </div>
            """, unsafe_allow_html=True)
...
# Ensure active_specialist is set
if "active_specialist" not in st.session_state or st.session_state.active_specialist is None:
    st.session_state.active_specialist = list(SPECIALISTS.keys())[0]
...
# --- SETTINGS ---
    ...
    with settings_tabs[1]:
        ...
        **Cloud Deployment:**
        ...
        Your API key is securely configured through the application's secrets management.
        For configuration assistance, contact The ATM Agency.
        
        **For Testing:**
        - Enter your API key below (stored only for this session)
    ...
    with settings_tabs[3]:
        ...
        **Health Data:** HL7, CCDA, FHIR
        ...
        This application is optimized for cloud deployment.
        
        For deployment assistance, please contact The ATM Agency directly.
