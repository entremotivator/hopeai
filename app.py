...
<style>
    ...
    /* --- ROBUST SIDEBAR TOGGLE SOLUTION --- */
    ...
    [data-testid="stSidebarCollapse"] {{
        ...
        border: 3px solid {PRIMARY_COLOR} !important; /* Highlight with primary color */
        width: 65px !important;
        height: 65px !important;
        transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1) !important;
    }}

    /* Position the open button when sidebar is closed */
    ...
    /* Style the icon inside the toggle */
    ...
    /* Ensure the close button inside the sidebar is also prominent */
    ...
    /* Sidebar Styling - Solid Dark Theme */
    ...
    div[data-testid="stSidebar"] .stRadio label {{
        ...
        color: #F8FAFC !important;
        padding: 1.25rem 1.5rem !important; /* Bigger buttons */
        border-radius: 16px !important;
...
with st.sidebar:
    ...
    <div class="sidebar-brand">
        <h1>🏥 {BRAND_NAME}</h1>
        <p style='color: #64748B; margin: 0.25rem 0 0 0; font-size: 0.75rem;'>Powered by LangChain & GPT-4</p>
        <p style='color: #475569; margin: 0; font-size: 0.65rem;'>By {CREATED_BY} | v{VERSION}</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with st.expander("🧭 Navigation Menu", expanded=True):
        # Use a more robust way to handle navigation
        current_index = 0
...
if st.session_state.current_page == "Executive Dashboard":
    ...
    cols = st.columns(5)
    for col, (name, value, delta, inverse, desc) in zip(cols, metrics):
        with col:
            st.metric(
                label=name,
                value=value,
...
# --- WELLNESS PROTOCOLS ---
    ...
    protocol_tabs = st.tabs(["🧬 Peptides", "⚖️ Hormones", "🥗 Nutrition", "⚡ Longevity", "🌙 Sleep", "🧠 Cognitive", "💪 Exercise"])
